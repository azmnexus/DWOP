...
@router.post("", response_model=ClientRead, status_code=201, dependencies=[Depends(RequireManager)])
...
@router.delete("/{client_id}", status_code=status.HTTP_204_NO_CONTENT, dependencies=[Depends(RequireManager)])
