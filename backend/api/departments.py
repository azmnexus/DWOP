...
@router.post("", response_model=DepartmentRead, status_code=201, dependencies=[Depends(RequireAdmin)])
...
@router.delete("/{dept_id}", status_code=status.HTTP_204_NO_CONTENT, dependencies=[Depends(RequireAdmin)])
