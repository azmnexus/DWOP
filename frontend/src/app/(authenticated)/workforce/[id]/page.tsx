...
export default function ProfessionalProfilePage() {
  ...
  // TODO: Load runs here when the API supports filtering onboarding runs by professional ID.
      ...
      try {
        ...
        if (err instanceof ApiRequestError) {
          if (err.status === 403) {
            ...
            setError({
              type: "error",
              message: "Professional not found in the current tenant.",
            });
  ...
  const engagement =
    person.engagements.length > 0 ? person.engagements[0] : null;
